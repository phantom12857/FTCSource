...
@Autonomous(name="Red 2: Auto Drive", group="Pushbot")
//@Disabled

public class MecanumBlue2 extends LinearOpMode {
...
//37.0
    public void runOpMode() {
        ...
        robot.ForwardLeft.setPower(0.2);
        robot.ForwardRight.setPower(-0.2);
        robot.BackwardLeft.setPower(0.2);
        robot.BackwardRight.setPower(-0.2);
        sleep(1250);
